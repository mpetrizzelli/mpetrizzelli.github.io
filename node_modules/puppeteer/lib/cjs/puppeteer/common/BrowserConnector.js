...
const connectToBrowser = async (options) => {
    ...
    return Browser_js_1.Browser.create(connection, browserContextIds, ignoreHTTPSErrors, defaultViewport, undefined, () => connection.send('Browser.close').catch(helper_js_1.debugError), targetFilter, isPageTarget);
};
