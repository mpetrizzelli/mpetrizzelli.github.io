...
class FrameManager extends EventEmitter_js_1.EventEmitter {
    ...
    async _onAttachedToTarget(event) {
        ...
        const connection = Connection_js_1.Connection.fromSession(this._client);
    ...
    mainFrame() {
        (0, assert_js_1.assert)(this._mainFrame, 'Requesting main frame too early!');
    ...
    _onExecutionContextCreated(contextPayload, session) {
        ...
        const frame = typeof frameId === 'string' ? this._frames.get(frameId) : undefined;
        let world;
        if (frame) {
...
class Frame {
    ...
    constructor(frameManager, parentFrame, frameId, client) {
        ...
        this._parentFrame = parentFrame !== null && parentFrame !== void 0 ? parentFrame : null;
        this._url = '';
        this._id = frameId;
        this._detached = false;
        this._loaderId = '';
