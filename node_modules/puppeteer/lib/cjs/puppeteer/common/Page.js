...
class Page extends EventEmitter_js_1.EventEmitter {
    ...
    constructor(client, target, ignoreHTTPSErrors, screenshotTaskQueue) {
        ...
        this._frameManager.on(FrameManager_js_1.FrameManagerEmittedEvents.FrameAttached, (event) => this.emit("frameattached" /* PageEmittedEvents.FrameAttached */, event));
        this._frameManager.on(FrameManager_js_1.FrameManagerEmittedEvents.FrameDetached, (event) => this.emit("framedetached" /* PageEmittedEvents.FrameDetached */, event));
        this._frameManager.on(FrameManager_js_1.FrameManagerEmittedEvents.FrameNavigated, (event) => this.emit("framenavigated" /* PageEmittedEvents.FrameNavigated */, event));
    ...
    on(eventName, handler) {
        if (eventName === 'request') {
            const wrap = this._handlerMap.get(handler) ||
                ((event) => {
    ...
    _addConsoleMessage(eventType, args, stackTrace) {
