...
export class Page extends EventEmitter {
    ...
    constructor(client, target, ignoreHTTPSErrors, screenshotTaskQueue) {
        ...
        this._frameManager.on(FrameManagerEmittedEvents.FrameAttached, (event) => this.emit("frameattached" /* PageEmittedEvents.FrameAttached */, event));
        this._frameManager.on(FrameManagerEmittedEvents.FrameDetached, (event) => this.emit("framedetached" /* PageEmittedEvents.FrameDetached */, event));
        this._frameManager.on(FrameManagerEmittedEvents.FrameNavigated, (event) => this.emit("framenavigated" /* PageEmittedEvents.FrameNavigated */, event));
