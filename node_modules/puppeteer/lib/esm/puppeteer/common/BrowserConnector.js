...
export const connectToBrowser = async (options) => {
    ...
    return Browser.create(connection, browserContextIds, ignoreHTTPSErrors, defaultViewport, undefined, () => connection.send('Browser.close').catch(debugError), targetFilter, isPageTarget);
};
